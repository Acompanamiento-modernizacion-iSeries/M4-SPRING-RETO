...
public class CuentaBancariaBasica extends CuentaBancariaEntity{

    public CuentaBancariaBasica() {
        super();
    }

    public CuentaBancariaBasica(Long id, String cuenta, BigDecimal saldo, List<TransaccionEntity> transacciones) {
    ...
    public void depositoCajero(BigDecimal valor){
        saldo = saldo.add(valor).subtract(new BigDecimal(2));
    }
    ...
    public void retiroCajero(BigDecimal valor){
        saldo = saldo.subtract(valor).subtract(new BigDecimal(1));
    }
}
