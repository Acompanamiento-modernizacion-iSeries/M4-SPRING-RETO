...
public class CuentaService {
    ...
    public Cuenta save(CreaCuentaDTO crearDTO) {
        ...
        if (cuentaExistente.isPresent()) {
            throw new RuntimeException(" Cuenta" + crearDTO.consultarNroCuenta() + " ya existe!");
        }
        ...
        if (cuentaNueva == null) {
            throw new RuntimeException("Cuenta no creada");
        }
    ...
    public Cuenta obtenerSaldo(ConsultaCuentaDTO consultaCuentaDTO) {
          ...
          if (cuentaEncontrada.isEmpty() ) {
              throw new NoSuchElementException("Cuenta"+ consultaCuentaDTO.getNroCuenta()+" no existe!");
          }
