...
public class CuentaService {
    ...
    public Cuenta save(CreaCuentaDTO crearDTO) {
        Optional<Cuenta> cuentaExistente = cuentaRepository.EncontrarNroCuenta(crearDTO.consultarNroCuenta());
        if (cuentaExistente.isPresent()) {
            throw new RuntimeException("La cuenta " + crearDTO.consultarNroCuenta() + " ya existe");
        }
        ...
        if (cuentaNueva == null) {
            throw new RuntimeException("No creo la cuenta");
        }
    ...
    public Cuenta obtenerSaldo(ConsultaCuentaDTO consultaCuentaDTO) {
          Optional<Cuenta> cuentaEncontrada = cuentaRepository.EncontrarNroCuenta(consultaCuentaDTO.getNroCuenta());
          if (cuentaEncontrada.isEmpty() ) {
              throw new NoSuchElementException("Cuenta número "+ consultaCuentaDTO.getNroCuenta()+" no existe!");
          }
